    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={7764674199}"
                ...
                signed_api = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={7764674199}"
